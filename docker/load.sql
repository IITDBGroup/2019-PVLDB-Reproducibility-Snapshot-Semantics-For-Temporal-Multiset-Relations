-- create schema of employees database and load data
...
\i /datasets/employee/load_departments.sql
\echo 'LOADING employees'
\i /datasets/employee/load_employees.sql
\echo 'LOADING dept_emp'
\i /datasets/employee/load_dept_emp.sql
\echo 'LOADING dept_manager'
\i /datasets/employee/load_dept_manager.sql
\echo 'LOADING titles'
