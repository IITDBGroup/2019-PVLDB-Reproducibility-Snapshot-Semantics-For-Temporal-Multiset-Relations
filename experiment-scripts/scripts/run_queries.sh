...
do         
         ...
         then
            echo -e "running q$i ..."
            $DIR/scripts/time_query.sh time_tpch_1gb $DIR/gprom_queries/q$i.sql 2 1 > $DIR/result/q_temp.txt
...
do
         ...
         then
            echo -e "running q$i ..."
            $DIR/scripts/time_query.sh employees $DIR/gprom_queries/q$i.sql 2 1 > $DIR/result/q_temp.txt
            mv $DIR/result/q_temp.txt $DIR/result/q$i.txt
         fi;            
done;
...
do
         ...
         then
            echo -e "running $i ..."
            $DIR/scripts/time_query.sh employees $DIR/gprom_queries/$i.sql 2 1 > $DIR/result/q_temp.txt
